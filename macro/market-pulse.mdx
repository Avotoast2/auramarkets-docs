...
- **Factor-basket extremes** — auramarkets' in-house [momentum / high-beta / low-vol L/S spreads and squeeze baskets](/indices/overview#the-factor-baskets) moving ≥2σ against their own history, reported with their σ · p line and empirical rank ("worst 1M run on record") — the de-grossing/squeeze-day detector
