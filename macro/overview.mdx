...
The default view is yours to arrange: the header's **Layout** button [reorders or removes any section](/getting-started/customize) — and the Pulse rail itself can be removed if you want the full width.
...
<CardGroup cols={2}>
  ...
  <Card title="Credit Monitor" href="/macro/credit">
