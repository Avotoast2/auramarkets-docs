...
- **High SKEW (`p90+`)** = paying up for tail-risk hedges. Smart-money hedging or genuine worry.
- **Low SKEW (`p10–`)** = complacency about the left tail. Historically, this has preceded sharp drawdowns more often than headline VIX has.
